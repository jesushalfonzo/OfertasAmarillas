...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2016 a las 06:54:44
...
CREATE TABLE `m_acciones` (
  `m_acciones_id` int(4) NOT NULL,
...
INSERT INTO `m_categorias` (`m_categoria_id`, `m_categoria_nombre`, `m_categoria_descripcion`, `m_categoria_estatus`) VALUES
(1, 'Hogar', 'dsfsdf', 1);
...
CREATE TABLE `m_clientes` (
  ...
  `m_cliente_login` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `m_clientes` (`m_cliente_id`, `m_cliente_razonSocial`, `m_cliente_rif`, `m_cliente_mail`, `m_cliente_telefono`, `m_cliente_nombreContacto`, `m_cliente_telefonoContacto`, `m_cliente_login`, `m_cliente_password`, `m_cliente_estatus`, `m_cliente_verificado`, `m_cliente_fecharegistro`) VALUES
(3, 'LarryCapinga C.A', 'V-17955911-1', 'jesushalfonzo@gmail.com', '00584125541104', 'Jes&uacute;s Alfonzo', '00584264011816', 'jalfonzo', '+uMgkucq9&gt;&gt;(zcd', 1, 0, '2016-05-03 15:08:04'),
(4, 'NenucoFilia S.A', 'V-17955911-0', 'jvalera@gmail.com', '00584125541104', 'Johan Valera', '00584264011816', 'jalfonzo', 'o#t0Ibel7wia512', 1, 1, '2016-05-03 15:13:01'),
(5, 'ElBizarro C.A', 'V-17955911-2', 'castro@gmail.com', '00584125541104', 'Eduard Castro', '00584264011816', 'jalfonzo2', 'kq8ibu75*uDHulh', 1, 0, '2016-05-04 10:03:10'),
(6, 'MaquillajesyMaricuras C.A', 'V-17955911-3', 'jashet@gmail.com', '00584125541104', 'Jashet Villegas', '00584264011816', 'jalfonzo3', 'kq8ibu75*uDHulh', 0, 1, '2016-05-04 10:04:50'),
(7, 'Inversiones 154 C.A', 'V-17955911-4', 'pedroperez@gmail.com', '00584125541104', 'Pedro Perez', '00584264011816', 'jalfonzo4', 'kq8ibu75*uDHulh', 1, 1, '2016-05-04 10:06:32'),
(8, 'Coraz&oacute;n de Jes&uacute;s S.A', 'G-19446720-2', 'probandoando@gmail.com', '00584125541104', 'Milagro L&oacute;pez', '00584265558993', 'mlopez', 'djjvAtxHIqhrqmB', 0, 1, '2016-05-04 12:52:28');
...
CREATE TABLE `m_ofertas` (
  `m_oferta_id` int(11) NOT NULL,
  `m_oferta_titulo` varchar(256) COLLATE latin1_general_cs NOT NULL,
  `m_oferta_descripcion` longtext COLLATE latin1_general_cs NOT NULL,
  `m_oferta_num_cupones` int(11) NOT NULL,
  `m_oferta_precio_real` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `m_categoria_id` int(11) NOT NULL,
  `m_oferta_fecha_inicio` datetime NOT NULL,
  `m_oferta_fecha_fin` datetime NOT NULL,
  `m_oferta_precio_venta` decimal(10,0) NOT NULL,
  `m_oferta_porcentaje_descuento` varchar(30) COLLATE latin1_general_cs NOT NULL,
  `m_cliente_id` int(11) NOT NULL,
  `m_oferta_foto` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `m_oferta_foto2` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `m_titulo` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `m_descripcion` longtext COLLATE latin1_general_cs NOT NULL
...
CREATE TABLE `m_permiso` (
  `m_permiso_id` int(4) NOT NULL,
  `m_grupo_id` int(4) NOT NULL,
...
(2, 'milagrotle', '6c5d50e7e28bf5b4319fa47c58e0483a', 'Milagro ', 'López', 1, 'A', 'milagrotle@gmail.com');
...
CREATE TABLE `m_ventas` (
  ...
  `m_oferta_id` int(11) NOT NULL,
  `m_cliente_id` int(11) NOT NULL,
  `m_venta_num_cupones` int(4) NOT NULL,
  `m_venta_fecha` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;
...
ALTER TABLE `bitacora_acceso`
  ADD PRIMARY KEY (`b_acceso_id`);

--
-- Indices de la tabla `m_acciones`
--
ALTER TABLE `m_acciones`
  ADD PRIMARY KEY (`m_acciones_id`);

--
-- Indices de la tabla `m_categorias`
--
ALTER TABLE `m_categorias`
  ADD PRIMARY KEY (`m_categoria_id`);

--
-- Indices de la tabla `m_clientes`
--
ALTER TABLE `m_clientes`
  ADD PRIMARY KEY (`m_cliente_id`);

--
-- Indices de la tabla `m_grupo`
--
ALTER TABLE `m_grupo`
  ADD PRIMARY KEY (`m_grupo_id`);

--
-- Indices de la tabla `m_ofertas`
--
ALTER TABLE `m_ofertas`
  ADD PRIMARY KEY (`m_oferta_id`),
  ADD KEY `idcliente` (`m_cliente_id`),
  ADD KEY `idcategoria` (`m_categoria_id`);
ALTER TABLE `m_ofertas` ADD FULLTEXT KEY `m_titulo` (`m_titulo`,`m_descripcion`);

--
-- Indices de la tabla `m_permiso`
--
ALTER TABLE `m_permiso`
  ADD PRIMARY KEY (`m_permiso_id`),
  ADD KEY `grupoid` (`m_grupo_id`),
  ADD KEY `accionid` (`m_accion_id`),
  ADD KEY `seccionid` (`m_seccion_id`);

--
-- Indices de la tabla `m_seccion`
--
ALTER TABLE `m_seccion`
  ADD PRIMARY KEY (`m_seccion_id`);

--
-- Indices de la tabla `m_usuario`
--
ALTER TABLE `m_usuario`
  ADD PRIMARY KEY (`m_usuario_id`),
  ADD KEY `idgrupo` (`m_grupo_id`);

--
-- Indices de la tabla `m_ventas`
--
ALTER TABLE `m_ventas`
  ADD PRIMARY KEY (`m_venta_id`),
  ADD KEY `idcliente1` (`m_cliente_id`),
  ADD KEY `idoferta` (`m_oferta_id`);
...
--
ALTER TABLE `bitacora_acceso`
  MODIFY `b_acceso_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
--
-- AUTO_INCREMENT de la tabla `m_acciones`
--
ALTER TABLE `m_acciones`
  MODIFY `m_acciones_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `m_categorias`
--
ALTER TABLE `m_categorias`
  MODIFY `m_categoria_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `m_clientes`
--
ALTER TABLE `m_clientes`
  MODIFY `m_cliente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `m_grupo`
--
ALTER TABLE `m_grupo`
  MODIFY `m_grupo_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `m_ofertas`
--
ALTER TABLE `m_ofertas`
  MODIFY `m_oferta_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `m_permiso`
--
ALTER TABLE `m_permiso`
  MODIFY `m_permiso_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `m_seccion`
--
ALTER TABLE `m_seccion`
  MODIFY `m_seccion_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `m_usuario`
--
ALTER TABLE `m_usuario`
  MODIFY `m_usuario_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `m_ventas`
--
ALTER TABLE `m_ventas`
  MODIFY `m_venta_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `m_ofertas`
  ADD CONSTRAINT `idcategoria` FOREIGN KEY (`m_categoria_id`) REFERENCES `m_categorias` (`m_categoria_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `idcliente` FOREIGN KEY (`m_cliente_id`) REFERENCES `m_clientes` (`m_cliente_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `m_ventas`
  ADD CONSTRAINT `idcliente1` FOREIGN KEY (`m_cliente_id`) REFERENCES `m_clientes` (`m_cliente_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `idoferta` FOREIGN KEY (`m_oferta_id`) REFERENCES `m_ofertas` (`m_oferta_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
